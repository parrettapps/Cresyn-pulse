...
// We keep these separate from our app-level user records.
// Our `users` table stores app profile data; Better Auth's
// `baUsers` table stores auth identity data.
// They are linked by email after successful OAuth.
// ============================================================

export const baUsers = pgTable('user', {
...
export const baVerifications = pgTable('verification', {
  id: text('id').primaryKey(),
...
export const baTwoFactors = pgTable('two_factor', {
  id: text('id').primaryKey(),
