...
export const PERMISSIONS = {
  // Accounts
  ACCOUNTS_COMPANIES_READ: 'accounts:companies:read',
  ACCOUNTS_COMPANIES_CREATE: 'accounts:companies:create',
  ACCOUNTS_COMPANIES_UPDATE: 'accounts:companies:update',
  ACCOUNTS_COMPANIES_DELETE: 'accounts:companies:delete',
  ACCOUNTS_CONTACTS_READ: 'accounts:contacts:read',
  ACCOUNTS_CONTACTS_CREATE: 'accounts:contacts:create',
  ACCOUNTS_CONTACTS_UPDATE: 'accounts:contacts:update',
  ACCOUNTS_CONTACTS_DELETE: 'accounts:contacts:delete',
  ACCOUNTS_NOTES_READ: 'accounts:notes:read',
  ACCOUNTS_NOTES_CREATE: 'accounts:notes:create',
  ACCOUNTS_NOTES_UPDATE: 'accounts:notes:update',
  ACCOUNTS_NOTES_DELETE: 'accounts:notes:delete',
  ACCOUNTS_DOCUMENTS_READ: 'accounts:documents:read',
  ACCOUNTS_DOCUMENTS_UPLOAD: 'accounts:documents:upload',
  // Pipeline
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  manager: [
    PERMISSIONS.ACCOUNTS_COMPANIES_READ,
    PERMISSIONS.ACCOUNTS_COMPANIES_CREATE,
    PERMISSIONS.ACCOUNTS_COMPANIES_UPDATE,
    PERMISSIONS.ACCOUNTS_CONTACTS_READ,
    PERMISSIONS.ACCOUNTS_CONTACTS_CREATE,
    PERMISSIONS.ACCOUNTS_CONTACTS_UPDATE,
    PERMISSIONS.ACCOUNTS_NOTES_READ,
    PERMISSIONS.ACCOUNTS_NOTES_CREATE,
    PERMISSIONS.ACCOUNTS_NOTES_UPDATE,
    PERMISSIONS.ACCOUNTS_DOCUMENTS_READ,
    PERMISSIONS.ACCOUNTS_DOCUMENTS_UPLOAD,
...
export const MODULE_REQUIRED_PERMISSIONS: Record<ModuleKey, Permission[]> = {
  accounts: [PERMISSIONS.ACCOUNTS_COMPANIES_READ],
...
export const RATE_LIMITS = {
  ...
  UNAUTHENTICATED_MAX: 100, // Increased for development (TODO: implement per-user rate limiting)
} as const;
